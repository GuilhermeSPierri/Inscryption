...
class StartPage(Page):
    ...
    def create_widgets(self):
        ...
        game_button = Button(self, "Iniciar Partida", 20, 5, "start_match", self.controller,font=self.custom_font_buttons)
        game_button.place(relx=0.5, rely=0.6, anchor="center")

        deck_button = Button(self, "Criar Deck", 20, 5, "show_frame", self.controller, ("DeckPage",), font=self.custom_font_buttons)
        deck_button.place(relx=0.5, rely=0.7, anchor="center")

        exit_button = Button(self, "Sair do Jogo", 20, 5, "leave_game", self.controller, font=self.custom_font_buttons)
